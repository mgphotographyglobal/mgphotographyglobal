          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.9rem", marginBottom: "1.5rem" }}>
              {[
                ...
                { icon: "📍", text: "Service area: Dubai, UAE" },
              ].map(({ icon, text }) => (
            ...
            <div style={{ marginTop: "1.25rem", padding: "0.75rem 1rem", border: "1px solid rgba(201,168,76,0.2)", background: "rgba(201,168,76,0.04)", display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <span style={{ color: "var(--gold)", fontSize: "0.75rem", fontWeight: 700, fontFamily: "var(--font-body)", letterSpacing: "0.08em" }}>UAE</span>
              <span className="body-sm" style={{ fontSize: "0.72rem" }}>Doorstep service · Dubai · Abu Dhabi · Sharjah</span>
            </div>
          </div>
        </div>
