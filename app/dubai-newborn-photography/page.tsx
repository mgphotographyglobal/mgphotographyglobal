...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "When is the best time for a newborn photography session in Dubai?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "The ideal window is between 5–21 days of life. During this time, babies sleep deeply and curl into the beautiful poses that make newborn photography so special.",
      },
    },
    {
      "@type": "Question",
      name: "Do you travel to homes in Dubai for newborn photography?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes — we offer luxury home-visit newborn photography sessions only, across all areas of Dubai including Downtown, Dubai Marina, JBR, Arabian Ranches, and Jumeirah. We bring a full professional home studio setup, props, backdrops, and equipment directly to you.",
      },
    },
    {
      "@type": "Question",
      name: "How many photos will we receive from a newborn session?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Depending on your package, you'll receive between 25–80+ professionally hand-retouched images, delivered via private online gallery within 5–7 working days.",
      },
    },
    {
      "@type": "Question",
      name: "How much does newborn photography cost in Dubai?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our luxury home newborn photography collections in Dubai start from AED 800 for the Essence Collection, AED 1,250 for the Signature Collection, and AED 2,000 for the Legacy Collection. Contact us via WhatsApp for custom quotes.",
      },
    },
    {
      "@type": "Question",
      name: "How far in advance should I book a Dubai newborn photographer?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "We recommend booking during pregnancy, ideally around 28–32 weeks. Newborn slots are limited and fill quickly. We hold a tentative date and confirm the exact session time once your baby arrives.",
      },
    },
  ],
};
