...
export default function OutdoorLocationsGuide() {
  return (<>
    ...
    <section style={{paddingBottom:"5rem",background:"var(--black)"}}>
      <div className="container-luxury" style={{maxWidth:"820px"}}>
        <p className="body-lg" style={{marginBottom:"1.5rem",marginTop:"2rem"}}>At MG Photography UAE, we schedule all outdoor sessions around Dubai&apos;s golden hour — the magical 45–60 minutes before sunset when the light turns warm, golden, and impossibly beautiful. This is the secret behind the cinematic quality of our outdoor work. Let us show you Dubai&apos;s most stunning hidden gems and iconic locations.</p>
        <p className="body-lg" style={{marginBottom:"3rem"}}>Browse our <a href="/outdoor-photography-dubai/" style={{color:"var(--gold)",textDecoration:"underline",textUnderlineOffset:"0.2em"}}>Dubai outdoor photography service</a> for session examples and booking information.</p>
