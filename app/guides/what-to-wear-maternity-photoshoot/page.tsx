      ...
      <div className="container-luxury" style={{maxWidth:"820px"}}>
        <div style={{display:"flex",flexDirection:"column",gap:"3rem",marginTop:"2.5rem"}}>
          {[
            ...
            {title:"Layer for Variety: Fitted Underneath, Flowing on Top",body:"A well-fitted underdress paired with a sheer, flowing overlay gives you the best of both worlds — definition where you want it, movement where it matters for photographs. It's also worth bringing a second outfit: one flowing gown for movement-based shots, and one simpler, fitted outfit (or even your partner's shirt) for quieter, more intimate portraits."},
          ].map(sec=>(
